...
public class Bootcamp {
    ...
    private LocalDate dataInicio = LocalDate.now(); // a data inicial será a data que for criado
    private final LocalDate dataFinal = dataInicio.plusDays(45); // adiciona 45 dias a partir da data inicial
    private Set<Dev> devsInscritos = new HashSet<>(); // ordem não importa
    private Set<Conteudo> conteudos = new LinkedHashSet<>(); // ordem dos cursos importa
